...
- `--mappable_bases MAPPABLE_BASES` - Three column (chrom, start, end) tabix-indexed BED file listing mappable positions. For GRCh38 you can use K36 mappable bases with [ENCODE blacklist](https://github.com/Boyle-Lab/Blacklist/tree/master/lists) excluded [GRCh38_no_alts.K36.n150.center_sites_and_extended_blacklist.bed.gz](https://resources.altius.org/~sabramov/files/hotspot3/GRCh38_no_alts.K36.n150.center_sites_and_extended_blacklist.bed.gz)
