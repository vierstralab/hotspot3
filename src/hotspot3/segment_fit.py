...
from hotspot3.models import FitResults, WindowedFitResults
...
class SegmentFit(WithLogger):
    ...
    def fit_segment_thresholds(self, agg_cutcounts: ma.MaskedArray, global_fit: FitResults=None, step=None):
        if step is None:
    ...
    def fit_segment_params(self, agg_cutcounts: ma.MaskedArray, thresholds: np.ndarray, global_fit: FitResults=None) -> WindowedFitResults:
