...
from hotspot3.models import ProcessorConfig, GlobalFitResults
...
class PvalueEstimator:
    ...
    def estimate_pvalues(self, agg_cutcounts: np.ndarray, fit_results: GlobalFitResults) -> np.ndarray:
